...
namespace proyectoTienda.Data.Migrations
{
    ...
    [Migration("20250515232913_xdddddddddddddddddddddddd")]
    partial class xdddddddddddddddddddddddd
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("proyectoTienda.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("proyectoTienda.Models.Model.Contacto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("proyectoTienda.Models.Model.Direccion", b =>
                {
            ...
            modelBuilder.Entity("proyectoTienda.Models.Model.ubicacion.Departamento", b =>
                {
            ...
            modelBuilder.Entity("proyectoTienda.Models.Model.ubicacion.Distrito", b =>
                {
            ...
            modelBuilder.Entity("proyectoTienda.Models.Model.ubicacion.Provincia", b =>
                {
                    b.Property<int>("ProvinciaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("proyectoTienda.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("proyectoTienda.Models.Model.ubicacion.Distrito", b =>
                {
                    b.HasOne("proyectoTienda.Models.Model.ubicacion.Provincia", "Provincia")
                        .WithMany("Distritos")
            ...
            modelBuilder.Entity("proyectoTienda.Models.Model.ubicacion.Provincia", b =>
                {
                    b.HasOne("proyectoTienda.Models.Model.ubicacion.Departamento", "Departamento")
                        .WithMany("Provincias")
